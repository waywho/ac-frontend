...
export default {
  ...
  computed: {
  	messageState () {
  		if(this.messaging !== null && this.messaging !== undefined && this.messaging.message !== null && this.messaging.message !== undefined) {
...
.notice {
	background-color: #87c4d5;
}

.success {
	background-color: #87d592;
}
</style>
