...
const getters = {
	static: (state) => (id) => {
		return state.staticPages[id]
	},
	opportunityTypes: () => {
		return state.opportunityTypes
	},
	categories: () => {
		return Object.keys(state.categorySubcategories)
	},
	subcategories: (state) => (category) => {
		return state.categorySubcategories[category]
	},
	paymentTypes: () => {
